                        ...
                        <StandardDataTable :columns="routeColumns" :data="routesList" :loading="isLoading"
                          ...
                          <template #actions="{ row }">
                            <div class="d-flex gap-1">
                              ...
                              <button class="btn btn-secondary btn-sm" @click="openRouteModal(row)">
                                <i class="fa fa-edit"></i>
                              </button>
...
const saveQuickCity = async () => {
  try {
    ...
    const response = await axiosInstance.post('/locations', { ...payload, type: 'CITY' });
...
const fetchroutes = async () => {
  try {
    const response = await axiosInstance.get('/routes?is_active=true');
