<template>
  <div v-if="!isCreationMode" class="row layout-top-spacing rounded bg-white mt-2">
    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
      <div class="panel br-6 p-0">
        <div class="custom-table p-3">
          <StandardDataTable :columns="citylinkColumns" :data="cityLinks" :loading="isLoading"
            :filters="cityLinkTableOption" :defaultPageSize="cityLinkTableOption.pageSize" :disablePagination="false"
            :showDateFilters="false" :actionButtons="citylinkpageActions">
            <template #code="{ row }">
            ...
            <template #actions="{ row }">
              ...
              <button class="btn btn-secondary btn-sm" @click="openCityLinkModal(row)">
...
import CityLinkRegistrationFrom from "./registerCityLink.vue"
  ...
  try {
    ...
    if (isMultipleMode.value) {
      ...
      if (response.data.status === "success") {
        ...
        isLoading.value = false;
        cityLinksLoaded.value = false;
        close(); // Reset flag to reload data
