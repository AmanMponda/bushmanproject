...
<template>
	...
	<div id="header" class="app-header navbar navbar-expand-lg p-0">
		<div class="container-xxl px-3 px-lg-5">
			...
			<RouterLink to="/" class="navbar-brand d-flex align-items-center position-relative me-auto">
				...
				<span
					class="badge text-body text-opacity-75 fw-bold fs-10px position-absolute end-0 top-0 mt-n1 me-n4">Bs5</span>
			</RouterLink>
			...
			<div class="ms-3">
				<RouterLink to="/" class="btn btn-theme fw-bold rounded-pill px-3 py-2">Get started <i
						class="fa fa-arrow-right ms-2 opacity-5"></i></RouterLink>
			</div>
		</div>
	</div>
	<!-- END #header -->
	...
	<!-- BEGIN #home -->
	<div id="home" class="py-5 position-relative bg-gray-900" data-bs-theme="dark"
		style="background-image: url(/assets/img/landing/hero-cover.png); background-repeat: no-repeat; background-position: top left; background-size: auto 100%;">
		<!-- BEGIN container -->
		<div class="container-xxl p-3 p-lg-5">
			...
			<div class="div-hero-content z-3 position-relative">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="mb-2">
							<RouterLink to="/" class="btn btn-lg btn-theme px-3">Discover Our Template <i
									class="fa fa-arrow-right ms-2 opacity-5"></i></RouterLink>
						</div>
			...
			<div class="position-absolute top-0 bottom-0 end-0 w-50 ps-5 overflow-hidden d-lg-block d-none">
				<img class="w-100 h-100 d-block position-relative object-fit-cover" alt="Studio"
	...
	<div id="about" class="py-5 bg-component">
		<div class="container-xxl p-3 p-lg-5 text-center">
			...
			<p class="fs-16px text-body text-opacity-50 mb-5">Studio Template crafts high-performance web applications
				for <br>developers, designers, and entrepreneurs, enabling effortless unleashing of creativity.</p>
			<div class="row text-start g-3 gx-lg-5 gy-lg-4">
				...
				<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
					...
					<div class="flex-1 ps-3">
						...
						<p class="mb-0">Modify layouts, colors, and more with ease. Studio Template offers unparalleled
				...
				<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
					...
					<div class="flex-1 ps-3">
						...
						<p class="mb-0">Fast loading times and efficient coding practices ensure a smooth user
							experience, even under heavy traffic.</p>
					</div>
				</div>
				<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
					<div
					...
					<div class="flex-1 ps-3">
						<h4>Secure</h4>
						<p class="mb-0">Built with security in mind, protecting your data and ensuring your complete
							peace of mind.</p>
					</div>
				</div>
				<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
	...
	<div id="features" class="py-5 position-relative" data-bs-theme="dark">
		...
		<div class="position-absolute bg-size-cover bg-position-center bg-no-repeat top-0 start-0 w-100 h-100"
			style="background-image: url(/assets/img/landing/content-cover.jpg);"></div>
	...
	<div id="pricing" class="py-5 bg-component">
		<div class="container-xxl p-3 p-lg-5">
			...
			<p class="fs-16px text-body text-opacity-50 text-center mb-0">Choose the perfect plan that suits your needs.
				...
				<br>Explore our plans to find the best fit for your requirements.
			</p>
			...
			<div class="row g-3 py-3 gx-lg-5 py-lg-5">
						...
						<div class="card-body fs-13px p-25px d-flex flex-column">
							<div class="d-flex align-items-center">
								<div class="flex-1">
									...
									<div class="h2 fw-bold mb-0">$5 <small
							...
							<div class="mb-5 text-body text-opacity-75 flex-1">
								...
								<div class="d-flex align-items-center mb-1">
									<i class="fa fa-check fa-lg text-gray-500"></i>
									<div class="flex-1 ps-3"><span class="font-monospace small">SSL Certificate:</span>
										<b class="text-body"> Shared</b>
									</div>
								</div>
								<div class="d-flex align-items-center mb-1">
									<i class="fa fa-check fa-lg text-gray-500"></i>
									<div class="flex-1 ps-3"><span class="font-monospace small">Email Accounts:</span>
							...
							<div class="mx-n2">
								<a href="#" class="btn btn-default btn-lg fs-16px w-100 font-monospace">Get Started <i
						...
						<div class="card-body fs-13px p-25px d-flex flex-column">
							<div class="d-flex align-items-center">
								<div class="flex-1">
									...
									<div class="h2 fw-bold mb-0">$10 <small
											class="h6 text-body text-opacity-50">/month*</small></div>
								</div>
								<div>
				...
				<div class="col-xl-3 col-md-4 col-sm-6 py-xl-0">
					<div class="card border-0 rounded-4 shadow bg-gradient-blue-indigo text-white h-100"
						data-bs-theme="dark">
						<div class="card-body fs-14px p-25px h-100 d-flex flex-column">
							<div class="d-flex align-items-center">
								<div class="flex-1">
									<div class="h6 font-monospace">Premium Plan</div>
									<div class="h1 fw-bold mb-0">$15 <small
											class="h6 text-body text-opacity-50">/month*</small></div>
								</div>
								<div>
							...
							<div class="mb-5 text-body flex-1">
								...
								<div class="d-flex align-items-center mb-1">
									<i class="fa fa-check text-white text-opacity-50 fa-lg"></i>
									<div class="flex-1 ps-3"><span class="font-monospace small">E-commerce
											Support</span></div>
								</div>
								<div class="d-flex align-items-center mb-1">
									<i class="fa fa-check text-white text-opacity-50 fa-lg"></i>
							...
							<a href="#" class="btn btn-light btn-lg fs-16px w-100 text-black font-monospace">Get Started
								<i class="fa fa-arrow-right ms-3 opacity-5"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-4 col-sm-6 py-xl-5">
						...
						<div class="card-body fs-13px p-25px d-flex flex-column">
							<div class="d-flex align-items-center">
								<div class="flex-1">
									...
									<div class="h2 fw-bold mb-0">$99 <small
											class="h6 text-body text-opacity-50">/month*</small></div>
								</div>
								<div>
							...
							<div class="mx-n2">
								<a href="#" class="btn btn-default btn-lg fs-15px w-100 font-monospace">Get Started <i
										class="fa fa-arrow-right"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="card p-4 border-0 h-100 rounded-5">
						...
						<div class="mb-4 d-flex">
							...
							<div class="p-3">
								...
								The customization options are unparalleled, and the support team is incredibly
								responsive.
							</div>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
						...
						<div class="flex-1 p-3 pb-0">
							...
							<p>Explore the fundamentals of responsive web design and learn essential tips to create
								websites that look great on any device.</p>
						</div>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
						...
						<div class="flex-1 p-3 pb-0">
							...
							<p>Essential security measures and best practices to safeguard your website and user data
				...
				<div class="col-lg-6">
					<form action="/" method="GET" name="form_contact_us">
						<div class="row gy-3 mb-3">
							...
							<div class="col-12">
								<button type="submit" class="btn btn-theme btn-lg btn-block px-4 fs-15px">Send
									Message</button>
							</div>
						</div>
					</form>
		...
		<div class="container-xxl px-3 px-lg-5">
			<div class="row gx-lg-5 gx-3 gy-lg-4 gy-3">
				<div class="col-lg-3 col-md-6">
					...
					<p class="mb-4">
						Studio is your go-to solution for creating stunning, responsive, and high-performance web
						applications. Designed for developers, designers, and entrepreneurs, it provides the tools and
						flexibility needed to bring your creative visions to life.
					</p>
					<h5>Follow Us</h5>
					<div class="d-flex">
						<a href="#" class="me-2 text-body text-opacity-50"><i
						...
						<a href="#" class="me-2 text-body text-opacity-50"><i
								class="fab fa-lg fa-youtube fa-fw"></i></a>
						<a href="#" class="me-2 text-body text-opacity-50"><i
								class="fab fa-lg fa-linkedin fa-fw"></i></a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<h5>Quick Links</h5>
					<ul class="list-unstyled">
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Newsroom</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Company
								Info</a></li>
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Careers</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">For
								Investors</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Brand
								Resources</a></li>
					</ul>
					<hr class="text-body text-opacity-50">
					<h5>Services</h5>
					<ul class="list-unstyled">
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Web
								Development</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">App
								Development</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">SEO</a>
						</li>
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Marketing</a></li>
					</ul>
				</div>
				<div class="col-lg-3 col-md-6">
					<h5>Resources</h5>
					<ul class="list-unstyled">
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Documentation</a></li>
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Support</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">FAQs</a>
						</li>
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Community</a></li>
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Tutorials</a></li>
					</ul>
					<hr class="text-body text-opacity-50">
					<h5>Legal</h5>
					<ul class="list-unstyled">
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Privacy
								Policy</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Terms of
								Service</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Cookie
								Policy</a></li>
						<li class="mb-3px"><a href="#"
								class="text-decoration-none text-body text-opacity-75">Compliance</a></li>
					</ul>
				</div>
				<div class="col-lg-3 col-md-6">
					<h5>Help Center</h5>
					<ul class="list-unstyled">
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Contact
								Form</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Live Chat
								Support</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Portal
								Help Center</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Email
								Support</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Technical
								Documentation</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Service
								Updates</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Developer
								API</a></li>
						<li class="mb-3px"><a href="#" class="text-decoration-none text-body text-opacity-75">Knowledge
								Base</a></li>
					</ul>
				</div>
			</div>
