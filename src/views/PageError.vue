	...
	<!-- BEGIN error -->
		<div class="error-page">
			...
			<div class="error-page-content">
				...
				<p class="mb-4">
					<!-- <RouterLink to="/companies-dashboard" class="text-decoration-none">Home</RouterLink> -->
				...
				<RouterLink to="/companies-dashboard" class="btn btn-theme">Go to Company Dashboard</RouterLink>
			</div>
